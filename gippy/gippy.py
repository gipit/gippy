...
class GeoImage(GeoResource):
    ...
    def open(*args, **kwargs):
        """
        open(svector filenames, bool update=True, float nodata=0, svector bandnames, double gain=1.0, double offset=0.0) -> GeoImage
    ...
    def save(self, *args, **kwargs):
        """
        save(GeoImage self, std::string filename, std::string dtype, std::string format, bool temp=False, bool overviews=False, gip::dictionary options) -> GeoImage
...
def GeoImage_open(*args, **kwargs):
    """
    GeoImage_open(svector filenames, bool update=True, float nodata=0, svector bandnames, double gain=1.0, double offset=0.0) -> GeoImage
