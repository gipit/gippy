...
class GeoImage(GeoResource):
    ...
    def create(*args, **kwargs):
        ...
        create(std::string filename="", unsigned int xsz=1, unsigned int ysz=1, unsigned int nb=1, 
            ...
            bool temp=False, gip::dictionary options=gip::dictionary()) -> GeoImage
    ...
    def open(*args, **kwargs):
        """
        open(svector filenames, bool update=True, float nodata=NAN, svector bandnames=std::vector< std::string >({}), 
            double gain=NAN, double offset=NAN) -> GeoImage
    ...
    def spectral_statistics(self, *args, **kwargs):
        """
        spectral_statistics(GeoImage self, Chunk chunk=gip::Chunk()) -> CImg< double >
    ...
    def save(self, *args, **kwargs):
        """
        save(GeoImage self, std::string filename="", std::string dtype="", float nodata=NAN, std::string format="", 
            bool temp=False, bool overviews=False, gip::dictionary options=gip::dictionary()) -> GeoImage
    ...
    def read_random_pixels(self, *args, **kwargs):
        """
        ...
        """
        return _gippy.GeoImage_read_random_pixels(self, *args, **kwargs)
    ...
    def extract_classes(self, *args, **kwargs):
        ...
        """
        return _gippy.GeoImage_extract_classes(self, *args, **kwargs)
...
def GeoImage_open(*args, **kwargs):
  """
    GeoImage_open(svector filenames, bool update=True, float nodata=NAN, svector bandnames=std::vector< std::string >({}), 
        double gain=NAN, double offset=NAN) -> GeoImage
